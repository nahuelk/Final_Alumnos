...
namespace GUI {
    ...
    public partial class FinalDataSet : global::System.Data.DataSet {
        ...
        public partial class EMPLEADOSDataTable : global::System.Data.TypedTableBase<EMPLEADOSRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EMPLEADOSRow AddEMPLEADOSRow(int DNI, string APELLIDO, string NOMBRE) {
...
namespace GUI.FinalDataSetTableAdapters {
    ...
    public partial class EMPLEADOSTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[EMPLEADOS] WHERE (([DNI] = @Original_DNI) AND ((@IsNull_APELLI" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[EMPLEADOS] ([DNI], [APELLIDO], [NOMBRE]) VALUES (@DNI, @APELLI" +
                "DO, @NOMBRE);\r\nSELECT DNI, APELLIDO, NOMBRE FROM EMPLEADOS WHERE (DNI = @DNI)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[EMPLEADOS] SET [DNI] = @DNI, [APELLIDO] = @APELLIDO, [NOMBRE] = @NOMBRE WHERE (([DNI] = @Original_DNI) AND ((@IsNull_APELLIDO = 1 AND [APELLIDO] IS NULL) OR ([APELLIDO] = @Original_APELLIDO)) AND ((@IsNull_NOMBRE = 1 AND [NOMBRE] IS NULL) OR ([NOMBRE] = @Original_NOMBRE)));
SELECT DNI, APELLIDO, NOMBRE FROM EMPLEADOS WHERE (DNI = @DNI)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT DNI, APELLIDO, NOMBRE FROM dbo.EMPLEADOS";
        ...
        public virtual int Fill(FinalDataSet.EMPLEADOSDataTable dataTable) {
        ...
        public virtual FinalDataSet.EMPLEADOSDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            FinalDataSet.EMPLEADOSDataTable dataTable = new FinalDataSet.EMPLEADOSDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(FinalDataSet.EMPLEADOSDataTable dataTable) {
