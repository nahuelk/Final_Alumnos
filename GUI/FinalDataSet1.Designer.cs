...
namespace GUI {
    ...
    public partial class FinalDataSet1 : global::System.Data.DataSet {
        ...
        public partial class MATERIASDataTable : global::System.Data.TypedTableBase<MATERIASRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public MATERIASRow AddMATERIASRow(int Id_materia, string Materia, int id_Catedra) {
...
namespace GUI.FinalDataSet1TableAdapters {
    ...
    public partial class MATERIASTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[MATERIAS] WHERE (([Id_materia] = @Original_Id_materia) AND ((@" +
                "IsNull_Materia = 1 AND [Materia] IS NULL) OR ([Materia] = @Original_Materia)) AN" +
                "D ([id_Catedra] = @Original_id_Catedra))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[MATERIAS] ([Id_materia], [Materia], [id_Catedra]) VALUES (@Id_" +
                "materia, @Materia, @id_Catedra);\r\nSELECT Id_materia, Materia, id_Catedra FROM MA" +
                "TERIAS WHERE (id_Catedra = @id_Catedra)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[MATERIAS] SET [Id_materia] = @Id_materia, [Materia] = @Materia, [id_Catedra] = @id_Catedra WHERE (([Id_materia] = @Original_Id_materia) AND ((@IsNull_Materia = 1 AND [Materia] IS NULL) OR ([Materia] = @Original_Materia)) AND ([id_Catedra] = @Original_id_Catedra));
SELECT Id_materia, Materia, id_Catedra FROM MATERIAS WHERE (id_Catedra = @id_Catedra)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id_materia, Materia, id_Catedra FROM dbo.MATERIAS";
        ...
        public virtual int Fill(FinalDataSet1.MATERIASDataTable dataTable) {
        ...
        public virtual FinalDataSet1.MATERIASDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            FinalDataSet1.MATERIASDataTable dataTable = new FinalDataSet1.MATERIASDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(FinalDataSet1.MATERIASDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id_materia, string Original_Materia, int Original_id_Catedra) {
        ...
        public virtual int Insert(int Id_materia, string Materia, int id_Catedra) {
        ...
        public virtual int Update(int Id_materia, string Materia, int id_Catedra, int Original_Id_materia, string Original_Materia, int Original_id_Catedra) {
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_id_Catedra));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Id_materia, string Materia, int Original_Id_materia, string Original_Materia, int Original_id_Catedra) {
            return this.Update(Id_materia, Materia, Original_id_Catedra, Original_Id_materia, Original_Materia, Original_id_Catedra);
        }
    }
